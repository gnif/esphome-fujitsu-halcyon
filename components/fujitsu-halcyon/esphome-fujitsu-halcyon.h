...
//        bool can_proceed() { return this->is_failed() || this->controller->is_initialized(); }
        ...
        void set_gpio_hold_high_ms(uint32_t hold_ms) { this->gpio_hold_high_ms_ = hold_ms; }
        void set_gpio_hold_high_pin(GPIOPin *pin) { this->gpio_hold_high_pin_ = pin; }
    ...
    protected:
        ...
        uint32_t gpio_hold_high_ms_{0};
        GPIOPin *gpio_hold_high_pin_{nullptr};
